                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="statistics-details d-flex align-items-center justify-content-between">
                                            <div>
                                                <p class="statistics-title">Global Interviews Held</p>
                                                <h3 class="rate-percentage global-interviews-count">123</h3>
                                                {{-- <p class="text-danger d-flex"><i
                                                        class="mdi mdi-menu-down"></i><span>-0.5%</span></p> --}}
                                            </div>
                                            <div>
                                                <p class="statistics-title">Your Interviews</p>
                                                <h3 class="rate-percentage user-interviews-count">11</h3>
                                                {{-- <p class="text-success d-flex"><i
                                                        class="mdi mdi-menu-up"></i><span>+0.1%</span></p> --}}
                                            </div>
                                            <div>
                                                <p class="statistics-title">Interviews Attempted</p>
                                                <h3 class="rate-percentage attempted-interviews-count">10</h3>
                                                {{-- <p class="text-danger d-flex"><i
                                                        class="mdi mdi-menu-down"></i><span>68.8</span></p> --}}
                                            </div>
                                            <div class="d-none d-md-block">
                                                <p class="statistics-title">Interviews Pending</p>
                                                <h3 class="rate-percentage pending-interviews-count">1</h3>
                                                {{-- <p class="text-success d-flex"><i
                                                ...
                                                <div class="card card-rounded">
                                                    <div class="card-body">
                                                        <div class="d-sm-flex justify-content-between align-items-start">
                                                            <div>
                                                                <h4 class="card-title card-title-dash">Pending Interviews</h4>
                                                                <p class="card-subtitle card-subtitle-dash ">You have <span class="pending-interviews-count">0</span> pending interviews</p>
                                                            </div>
                                                        </div>
 
                                                        <div class="chartjs-bar-wrapper mt-3">
                                                            <div id="pending-interviews-data"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

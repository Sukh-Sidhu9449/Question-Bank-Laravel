...
<head>
  ...
  <link rel="stylesheet" href="{{asset('vendorjs/select.dataTables.min.css') }}">
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="{{asset('vendorcss/vertical-layout-light/style.css') }}">
  <!-- endinject -->
      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="#">
            <img  src="{{asset('images/Question-Bank-Logo.webp') }}" alt="logo" />
          </a>
        ...
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">
                ...
                @endif
                {{-- Good Morning, --}}
                <span class="text-black fw-bold">{{auth()->user()->name?ucfirst(auth()->user()->name):""}}</span>
            </h1>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator" id="notificationDropdown" href="#" data-bs-toggle="dropdown">
              <i class="icon-mail icon-lg"><span class="countNotify"></span></i>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="notificationDropdown" id="notification">
              <a class="dropdown-item py-3 border-bottom count-div" href="{{ url('/notificationPanel') }}">
                <p class="mb-0 font-weight-medium float-left count" > </p>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="{{auth()->user()->image?auth()->user()->image:"/img/dummy-profile-pic.jpg"}}" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md  rounded-circle" src="{{auth()->user()->image?auth()->user()->image:"/img/dummy-profile-pic.jpg"}}" alt="Profile image">
                <p class="mb-1 mt-3 font-weight-semibold">{{ucfirst(auth()->user()->name)}}</p>
                <p class="fw-light text-muted mb-0">{{auth()->user()->email}}</p>
              </div>
              <a class="dropdown-item" href="{{ url('/user_edit') }}"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My Profile <span class="badge badge-pill badge-danger">1</span></a>
              <a class="dropdown-item" href="{{ url('/notificationPanel') }}"><i class="dropdown-item-icon mdi mdi-message-text-outline text-primary me-2"></i> Notification Panel</a>
